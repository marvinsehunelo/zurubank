...
<head>
    ...
    <title>Withdraw Money - Zuru Bank</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-gray-100 text-gray-800 font-inter min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="card bg-white p-8 rounded-lg shadow-lg max-w-sm w-full mt-24">
        <h2 class="text-3xl font-bold text-center mb-6">Withdraw Money</h2>
        ...
        <form method="POST" class="space-y-4">
            <div class="relative">
                <select name="account_id" class="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-900 focus:border-transparent">
